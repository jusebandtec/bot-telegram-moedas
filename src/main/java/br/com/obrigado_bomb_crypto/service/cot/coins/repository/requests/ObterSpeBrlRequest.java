...
public class ObterSpeBrlRequest extends HttpRequest {
    public ObterSpeBrlRequest() {
        setHttpMethod(HttpMethod.GET);
        setUriRelative("https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?id=18149&convert=BRL");
