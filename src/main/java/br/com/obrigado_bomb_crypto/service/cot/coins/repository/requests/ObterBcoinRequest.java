...
public class ObterBcoinRequest extends HttpRequest {
    public ObterBcoinRequest() {
        setHttpMethod(HttpMethod.GET);
        setUriRelative("https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?id=12252&convert=BRL");
